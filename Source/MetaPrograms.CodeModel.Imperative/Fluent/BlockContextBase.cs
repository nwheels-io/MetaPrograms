...
{
    public abstract class BlockContextBase : IDisposable
    {
        ...
        {
            ConvertStandaloneExpressionsToStatements();
            AttachBlock(_locals, _statements);
        }

        protected abstract void AttachBlock(IEnumerable<LocalVariable> locals, IEnumerable<AbstractStatement> statements);
        ...
        public static BlockContextBase GetBlockOrThrow()
        {
